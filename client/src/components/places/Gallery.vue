  ...
  <v-container fluid>
    ...
    <div>
      <div class="search-wrapper">
        ...
        <img
          class="yb"
          src="https://st3.depositphotos.com/27893600/33298/v/1600/depositphotos_332980766-stock-illustration-mark-position-location-pointer-map.jpg"
        />
        <input
          class="yas"
          type="text"
        ...
        <select class="select-css" v-model="select" @change="filtercategory">
          choose category
      ...
      <v-row justify="space-around">
        <v-col v-for="place in places" :key="place._id" cols="5">
          <v-card class="mx-auto" max-width="650">
            <v-img :src="place.imagelink" height="500px"></v-img>
...
export default {
  ...
  methods: {
    ...
    async filterPlaces() {
      var places = await axios.post(
        "http://localhost:5000/api/place/findPlace",
        { name: this.search }
      );
      this.places = places.data;
    },
